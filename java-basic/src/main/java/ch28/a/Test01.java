// 애노테이션
// => 클래스, 필드, 메서드, 로컬변수에 붙이는 특별한 주석이다.
// => 다른 주석과 달리 컴파일 할 때나 실행할 때 추출할 수 있다.
// => 애노테이션 문법이 사용되기 전에 일반 주석에 특별한 문법을 포함시켜 사용 했던 doclet 이라는 기술이 있었다.
// => 일반 주석과 달리 프로퍼티명=값 형태로 데이터 값을 다룰 수 있다.
// => 사용법
