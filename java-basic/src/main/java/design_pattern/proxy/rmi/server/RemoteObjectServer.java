...
public class RemoteObjectServer {
  public static void main(String[] args) {
    ...
    try {
      ...
      // => 첫 번째 파라미터 : 원격 객체
      // => 두 번째 파라미터 : 포트번호, 0으로 지정하면 임의의 유효한 포트 번호가 지정된다.
      ...
      // 5) Registry 도구를 사용하여 RMI Registry 서버에stub을 등록한다.
      ...
      System.out.println("Calcualtor 객체의 프록시(stub)가 RMI Registry 서버에 등록 되었다.");
