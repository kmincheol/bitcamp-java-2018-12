...
public class BoardDaoImpl implements BoardDao {
  ...
  public List<Board> findAll() {
    ...
    try (PreparedStatement stmt =
        con.prepareStatement("select board_id, conts, cdt, vw_cnt from lms_board")) {
  ...
  public int delete(int no) {
    ...
    try (PreparedStatement stmt = con.prepareStatement("delete from lms_board where board_id=?")) {
      stmt.setInt(1, no);
