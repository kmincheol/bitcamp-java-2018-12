...
public class Test01 {
  public static void main(String[] args) {
    ...
    //
    try (Connection con =
        DriverManager.getConnection("jdbc:mariadb://localhost/bitcampdb", "bitcamp", "1111")) {
