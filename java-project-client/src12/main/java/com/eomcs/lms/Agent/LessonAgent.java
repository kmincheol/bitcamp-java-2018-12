...
public class LessonAgent {
  ...
  public static void add(Lesson lesson, ObjectInputStream in, ObjectOutputStream out)
      throws Exception {
    ...
    String status = in.readUTF();
    if (!status.equals("OK"))
      throw new Exception("수업 데이터 추가 실패");
  }
  ...
  public static void update(Lesson lesson, ObjectInputStream in, ObjectOutputStream out)
      throws Exception {
