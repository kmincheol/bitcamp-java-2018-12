...
public class Test06 {
  ...
  static interface Player2 {
    ...
    // 인터페이스는 디폴드 메서드를 가질 수 있다.
    // => 기존 프로젝트에 영향을 끼치지 않으면서 기존 규칙에 새 메서드를 추가할 때 사용한다.
    default void stop() {
      // 어차피 새 메서드는 새 프로젝트의 구현체가 오버라이딩 것이니 여기에서는 자세하게 정의하지 않는다.
  ...
  public static void main(String[] args) {
    ...
    // Player3 p3 = () -> System.out.prinyln("Player3..."); // 컴파일 오류

    // 인터페이스가 아닌 추상 클래스는 람다 구현의 대상이 아니다!
    // Player4 p4 = () -> System.out.prinyln("Player4..."); // 컴파일 오류
  }
}
