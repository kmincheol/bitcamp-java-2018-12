...
public class Score3 implements Serializable {
  ...
  // 컴파일러의 경고가 뜨지 않는다.
  // => Test03_1을 실행하여 score3.data 파일을 인스턴스를 출력한 후
  //    이 클래스에 tel필드와 setter/getter 를 추가한다.
  //    또한 toSring()을 다시 생성한다.
  ...
  private String name;
  private String tel; // Test03_1을 실행한 후 이 필드를 추가하라.
  private int kor;
  private int eng;
  private int math;
  private int sum;
  ...
  // Test03_1을 실행하여 score3.data 파일에 인스턴스를 출력한 후
  ...
  // Test03_1을 실행하여 score3.data파일에 인스턴스를 출력한 후,
  // tel 필드를 추가하고 getter/setter을 추가하라
