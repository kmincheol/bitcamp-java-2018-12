...
// => 개발자가 직접 이 인터페이스를 붙인 클래스에 대해서만 serialze 할 수 있다.
...
public class Score2 implements Serializable {
  private String name;
  private String tel; // TEst02_1을 실행한 후 이 필드를 추가하라!
  private int kor;
  private int eng;
  private int math;
  private int sum;
  ...
  // Test02_1을 실행하여 Score2 값을 출력한 후 toString()메서드를 다시 생성하라.
  @Override
  ...
  // Test02_1을 실행하여 Score2 값을 출력한 후 tel 필드의 getter/setter를 추가하라.
