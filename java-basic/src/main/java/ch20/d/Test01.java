...
public class Test01 {
  public static void main(String[] args) {
    ...
    // 4) equals()의 리턴 값이 true라면 같은 키로 간주하여 해당 위치의 값을 꺼낸다.

    String key1 = "bbb";
    String key2 = new String("bbb");
    System.out.println(key1 == key2); // 인스턴스가 다르다.
    System.out.println(key1.hashCode() == key2.hashCode()); // 해시값은 같다.
    System.out.println(key1.equals(key2));
    // 결론: key1과 key2는 서로 다른 인스턴스 이지만, hashCode()의 리턴 값이 같고,
