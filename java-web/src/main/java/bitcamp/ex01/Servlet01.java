...
// 서블릿 클래스를 만든 후,
// 배치 파일(web.xml; DD파일)에 서블릿 정보를 등록해야만 실행 될 수 있다.
...
public class Servlet01 implements Servlet {
  ...
  public void destroy() {
    ...
    System.out.println("Servlet02.destory()");
  }
