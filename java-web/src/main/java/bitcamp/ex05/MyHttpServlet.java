...
// 따라서 GenericServlet을 상속받아 서블릿을 만들기 보다
// 이 클래스를 상속 받아 서블릿을 만든다면,
// 훨씬 편하게 서비스를 구현할 수 있을 것이다.
//
...
public abstract class MyHttpServlet extends GenericServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, IOException {
      // 웹 브라우저가 요청하면
      // => 서블릿 컨테이너가 service(ServletRequest req, ServletResponse res)를 호출한다.
      // => service(ServletRequest req, ServletResponse res)는
