...
//    - buile.gradle 파일에 의존 라이브러리 정보를 추가한다.
//    - 'gradle eclipse' 실행하여 라이브러리를 다운로드 받고 이클립스 설정파일에 등록
//    - 이클립스 프로젝트를 리프래시하여 라이브러리 정보를 반영한다.
// 2) Mybatis 설정 파일 준비
...
public class Test01 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //    예) c:/User/user/git/bitcamp-2018-12/java-basic/src/main/java/ch26/a/...
    ...
    //    - Build 디자인 패턴이 적용되어 있다.
    //      (여러 객체를 조립하여 한 객체를 생성하는 경우, 직접하는 대신에
    ...
    // => selectList()의 리턴 값을 SQL 매퍼 파일의 resultType에 지정된 객체를 담고 있는
    //    List 객체이다.
